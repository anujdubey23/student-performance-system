  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="bg-white rounded-xl p-6 border border-slate-200 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        {/* Prediction summary pill & What-if trigger */}
        <div className="flex items-center gap-3 shrink-0">
          <button
            onClick={() => navigate('/simulator')}
            className="inline-flex items-center gap-1.5 px-3.5 py-2.5 text-xs font-semibold text-teal-800 bg-teal-50 border border-teal-200 rounded-lg hover:bg-teal-100 transition-colors shadow-2xs"
          >
